...
public class UserResource {
	...
	@PostMapping
	public ResponseEntity<Void> insert(@RequestBody UserDTO objDto){ //para aceitar objeto vindo como argumento
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Void> update(@PathVariable String id, @RequestBody UserDTO objDto){ //para aceitar objeto vindo como argumento
		findById(id);
		User obj = service.fromDTO(objDto);
		obj.setId(id);
